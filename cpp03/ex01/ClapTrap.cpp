...
/*   Updated: 2023/09/24 21:22:25 by ahaloui          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap():clap_Name(""), clap_hitPoints(100), clap_energyPoints(50), clap_attackDamage(20)
{
...
ClapTrap::ClapTrap(std::string name):clap_Name(name), clap_hitPoints(100), clap_energyPoints(50), clap_attackDamage(20)
{
