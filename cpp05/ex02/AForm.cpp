...
AForm::AForm(std::string name_form, int grade_to_sign, int grade_to_execute) : name_form(name_form), signed_form(false), grade_to_sign(grade_to_sign), grade_to_execute(grade_to_execute)
{
